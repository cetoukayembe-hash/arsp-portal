...
On Mon, Jul 6, 2026 at 12:53 AM Badiata Kayembe <kayembe.badiata@gmail.com> wrote:
import { useNavigate } from 'react-router-dom';
import { useState } from 'react';
import {
 ClipboardList, Scale, TrendingUp, Building2, FileCheck, MapPin,
...
const missions = [
 { icon: ClipboardList, title: 'Recenser et agreer', desc: 'Recenser et agreer les entreprises eligibles a la sous-traitance selon leurs domaines d activites.' },
 { icon: Scale, title: 'Faire appliquer', desc: 'Faire appliquer les regles regissant l activite de sous-traitance.' },
 { icon: TrendingUp, title: 'Promouvoir', desc: 'Promouvoir les petites et moyennes entreprises a capitaux majoritairement Congolais.' },
 { icon: Building2, title: 'De l informel au formel', desc: 'Ramener les entreprises congolaises du secteur informel vers le secteur formel.' },
 { icon: FileCheck, title: 'Respect des engagements', desc: 'Veiller au respect des conditions requises dans la conclusion des contrats de sous-traitance.' },
...
const eligibility = [
 { title: 'Personne Physique', items: ['Etre de nationalite congolaise', 'Avoir son siege social en RDC', 'Majorite du personnel de nationalite congolaise', 'Avoir un RCCM', 'Avoir une Identification Nationale', 'Avoir un Numero d Impot', 'Produire une Attestation Fiscale', 'Attestation CNSS si applicable'] },
 { title: 'Personne Morale (Entreprise)', items: ['Siege social en RDC', 'Au moins 51% du capital social detenu par des congolais', 'Organes de gestion majoritairement congolais', 'Personnel essentiellement congolais', 'RCCM valide', 'Identification Nationale', 'Numero d Impot', 'Attestation Fiscale', 'Attestation CNSS'] },
 { title: 'Entreprenant', items: ['Declaration conforme a l Article 62 de l OHADA', 'Preuve de paiement de la patente'] },
 { title: 'Formation Medicale non commercante', items: ['Personnalite juridique ou autorisation du Ministere de la Sante', 'Siege en RDC', 'Majorite des membres de nationalite congolaise', 'Attestation CNSS'] },
...
export function LandingPage() {
 ...
 <div className="text-center mb-12">
 <h2 className="text-3xl font-bold text-white mb-2">Notre Mission</h2>
 <p className="text-blue-200">La vision strategique de l Autorite de Regulation</p>
 </div>
 <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
 {missions.map((m, i) => {
 const Icon = m.icon;
 ...
 <div className="max-w-3xl mx-auto">
 <div className="text-center mb-10">
 <h2 className="text-3xl font-bold text-[#0a2540] mb-2">Criteres d eligibilite</h2>
 <p className="text-gray-600">Verifiez que votre entreprise remplit les conditions requises</p>
 </div>
 <div className="space-y-3">
 {eligibility.map((e, i) => (
 <div key={i} className="border border-gray-200 rounded-xl overflow-hidden">
...
/>
 ...
 <div>
 <div className="font-bold text-[#0a2540]">ARSP</div>
 <div className="text-xs text-gray-500">Autorite de Regulation de la Sous-traitance</div>
 </div>
 </div>
 <p className="text-sm text-gray-600">Etablissement public regi par la loi n 17/001 du 08 fevrier 2017 fixant les regles applicables a la sous-traitance dans le secteur prive.</p>
 </div>
 <div>
 <h4 className="font-semibold text-[#0a2540] mb-4">Contact</h4>
 <div className="space-y-2 text-sm text-gray-600">
 ...
 <div className="max-w-6xl mx-auto mt-8 pt-6 border-t border-gray-200 text-center text-sm text-gray-500">
 2026 ARSP Autorite de Regulation de la Sous-traitance dans le secteur Prive. Tous droits reserves.
 </div>
 </footer>
